...
const exportType = {
  body: [
    `export type ${types_1.Placeholders.FirstTab} = {${types_1.Placeholders.SecondTab}}`,
  ],
  key: 'exportType',
  prefix: 'exptp',
};
...
const typescriptReactFunctionalExportComponentOne = {
...
exports.default = [
  ...
  typescriptReactFunctionalExportComponentOne,
